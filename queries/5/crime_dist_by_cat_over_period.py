...
df = pd.read_csv('5b.csv')

# Extract relevant columns for plotting
periods = df['periodLabel']
...
plt.title('Stacked Crime Statistics Over Different Periods')
plt.xticks(index, periods, rotation=70, ha='right')  # Rotate labels and set alignment
plt.legend()
plt.grid(True)
plt.subplots_adjust(bottom=0.25)
plt.savefig('crime_dist_by_cat_over_period.png', dpi=300)